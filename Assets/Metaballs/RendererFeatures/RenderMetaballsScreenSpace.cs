...
{
    public Shader _blitToDepthShader;
    ...
    class RenderMetaballsScreenSpacePass : ScriptableRenderPass
    {
        ...
        public RenderMetaballsScreenSpacePass(string profilerTag, RenderPassEvent renderPassEvent,
            string[] shaderTags,
            RenderQueueType renderQueueType, int layerMask, Shader blitShader, Shader blurShader)
        {
            profilingSampler = new ProfilingSampler(nameof(RenderObjectsPass));
            ...
            _blitCopyDepthMaterial = new Material(blitShader);
            _blurMaterial = new Material(blurShader);
            Debug.Log(_blurMaterial + "b");
            Debug.Log(_blitCopyDepthMaterial + "a");
        }
    ...
    public override void Create()
    {
        ...
        _scriptableMetaballsScreenSpacePass = new RenderMetaballsScreenSpacePass(PassTag, Event,
            FilterSettings.PassNames, FilterSettings.RenderQueueType, FilterSettings.LayerMask, _blitToDepthShader, _BlurShader)
        {
