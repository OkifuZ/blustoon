...
namespace ActiveRagdoll {
    ...
    public class Gripper : MonoBehaviour {
        ...
        private void Grip(Rigidbody whatToGrip) {
            ...
            // weapon
            weapon = whatToGrip.transform.GetComponent<Weaponize>();
            if (weapon != null)
            {
                weapon.setMaster(GripMod.ActiveRagdoll.ID);
            }
        }
